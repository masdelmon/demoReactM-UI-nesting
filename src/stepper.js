...
function getStepContent(step, datafrm, updateStateUsername, updateStatePassword, updateStateFirstName, updateStateLastName, updateStateEmail, updateStatePhone, updateStep, classes) {
  switch (step) {
    ...
    case 3:
     return <fieldset>Username:{datafrm.username} - Password:{datafrm.password} - <Button value="0" variant="contained" color="primary" onClick={updateStep} className={classes.button}>Modifica</Button></fieldset>;
    default:
