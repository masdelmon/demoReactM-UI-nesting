...
function getStepContent(step, datafrm, updateStateUsername, updateStatePassword, updateStateFirstName, updateStateLastName, updateStateEmail, updateStatePhone) {
  switch (step) {
    ...
    case 3:
     return <fieldset>Username:{datafrm.username} - Password:{datafrm.password}<Button onClick={this.handleStep(0)} className={classes.button}>Modifica</Button></fieldset>;
    default:
